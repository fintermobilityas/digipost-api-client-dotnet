...
internal static class DataTransferObjectConverter
{
    ...
    static DocumentEvent FromDataTransferObject(this Event myEvent)
    {
    ...
    static Identification IdentificationDataTransferObjectFromIdentificationById(this RecipientById recipientById)
    {
    ...
    static Identification IdentificationDataTranferObjectFromIdentificationByNameAndAddress(this RecipientByNameAndAddress recipientByNameAndAddress)
    {
    ...
    static Message_Recipient RecipientDataTransferObjectFromRecipientById(this RecipientById recipient)
    {
    ...
    static Message_Recipient RecipientDataTransferObjectFromRecipientByNameAndAddress(this IRecipientByNameAndAddress recipientByNameAndAddress)
    {
    ...
    static List<Print_Instruction> ToDataTransferObject(this IPrintInstructions printInstructions)
    {
    ...
    static Print_Instruction ToDataTransferObject(IPrintInstruction printInstruction)
    {
    ...
    static Print_Recipient ToDataTransferObject(this IPrint recipient)
    {
    ...
    static IdentificationResult IdentificationResultForDigipostOrPersonalIdentificationNumber(this Identification_Result identificationResultDto)
    {
    ...
    static IEnumerable<SharedDocument> FromDataTransferObject(this Collection<Shared_Document> dto)
    {
    ...
    static IOrigin FromDataTransferObject(this Shared_Document_Origin dto)
    {
